...
AddModel('resnet_v2_50', 'http://download.huan-zhang.com/models/adv/imagenet/frozen_imagenet_models_v1.1.tar.gz',
...
AddModel('resnet_v2_101', 'http://download.huan-zhang.com/models/adv/imagenet/frozen_imagenet_models_v1.1.tar.gz',
...
AddModel('resnet_v2_152', 'http://download.huan-zhang.com/models/adv/imagenet/frozen_imagenet_models_v1.1.tar.gz',
...
AddModel('inception_v1', 'http://download.huan-zhang.com/models/adv/imagenet/frozen_imagenet_models_v1.1.tar.gz',
...
AddModel('inception_v2', 'http://download.huan-zhang.com/models/adv/imagenet/frozen_imagenet_models_v1.1.tar.gz',
...
AddModel('inception_v3', 'http://download.huan-zhang.com/models/adv/imagenet/frozen_imagenet_models_v1.1.tar.gz',
...
AddModel('inception_v4', 'http://download.huan-zhang.com/models/adv/imagenet/frozen_imagenet_models_v1.1.tar.gz',
         'frozen_inception_v4.pb', 299, 'labels.txt', 'input:0', 
         'InceptionV4/Logits/Logits/BiasAdd:0', 'InceptionV4/Logits/Predictions:0', '')
AddModel('inception_resnet_v2', 'http://download.huan-zhang.com/models/adv/imagenet/frozen_imagenet_models_v1.1.tar.gz',
...
AddModel('vgg_16', 'http://download.huan-zhang.com/models/adv/imagenet/frozen_imagenet_models_v1.1.tar.gz',
         'frozen_vgg_16.pb', 224, 'labels.txt', 'input:0', 
         'vgg_16/fc8/squeezed:0', 'vgg_16/fc8/squeezed:0', '')
AddModel('vgg_19', 'http://download.huan-zhang.com/models/adv/imagenet/frozen_imagenet_models_v1.1.tar.gz',
         'frozen_vgg_19.pb', 224, 'labels.txt', 'input:0', 
         'vgg_19/fc8/squeezed:0', 'vgg_19/fc8/squeezed:0', '')
AddModel('mobilenet_v1_025', 'http://download.huan-zhang.com/models/adv/imagenet/frozen_imagenet_models_v1.1.tar.gz',
...
AddModel('mobilenet_v1_050', 'http://download.huan-zhang.com/models/adv/imagenet/frozen_imagenet_models_v1.1.tar.gz',
         'frozen_mobilenet_v1_050.pb', 224, 'labels.txt', 'input:0', 
         'MobilenetV1/Predictions/Reshape:0', 'MobilenetV1/Predictions/Reshape_1:0', 'MobilenetV1/Predictions/Shape:0')
AddModel('mobilenet_v1_100', 'http://download.huan-zhang.com/models/adv/imagenet/frozen_imagenet_models_v1.1.tar.gz',
         'frozen_mobilenet_v1_100.pb', 224, 'labels.txt', 'input:0', 
         'MobilenetV1/Predictions/Reshape:0', 'MobilenetV1/Predictions/Reshape_1:0', 'MobilenetV1/Predictions/Shape:0')
AddModel('nasnet_large', 'http://download.huan-zhang.com/models/adv/imagenet/frozen_imagenet_models_v1.1.tar.gz',
         'frozen_nasnet_large.pb', 331, 'labels.txt', 'input:0', 
         'final_layer/FC/BiasAdd:0', 'final_layer/predictions:0', '')
AddModel('densenet121_k32', 'http://download.huan-zhang.com/models/adv/imagenet/frozen_imagenet_models_v1.1.tar.gz',
...
AddModel('densenet169_k32', 'http://download.huan-zhang.com/models/adv/imagenet/frozen_imagenet_models_v1.1.tar.gz',
...
AddModel('densenet161_k48', 'http://download.huan-zhang.com/models/adv/imagenet/frozen_imagenet_models_v1.1.tar.gz',
...
AddModel('alexnet', 'http://download.huan-zhang.com/models/adv/imagenet/frozen_imagenet_models_v1.1.tar.gz',
